 ...
 * Verifica que el usuario que intenta modificar/eliminar sea el creador
 */
@Injectable()
export class OwnershipGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Si es admin o revisor, permitir acceso
    ...
    if (path.includes('/topics')) {
      ...
      if (topic.created_by.toString() !== user._id.toString()) {
        throw new ForbiddenException('Solo el creador puede modificar este tema');
      }
    }
